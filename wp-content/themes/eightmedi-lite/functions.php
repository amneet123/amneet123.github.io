...
/* custom code by kaur1115 */
/*
 to hide dashboard from non admin users
*/
...
/*   allow user to upload images from frontend */
if ( current_user_can('doctor') && !current_user_can('upload_files') )
    add_action('admin_init', 'allow_contributor_uploads');

function allow_contributor_uploads() {
    $doctor = get_role('doctor');
    $doctor->add_cap('upload_files');
}
