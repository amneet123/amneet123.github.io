					...
					<div class="header-callto clear">
						...
						<div class="callto-right">
							...
							<?php if(get_theme_mod('eightmedi_lite_social_icons_in_header','1')==1){ ?>
								...
								<?php
							// login logout start here 
							if ( is_user_logged_in() )
							 {
							 $current_user = wp_get_current_user();
							 $current_user_name = ucfirst($current_user->display_name);  // get current user name
							    ?>
							    Hi <?php echo $current_user_name;  ?>
							    <b><a href="<?php echo wp_logout_url( home_url() ); ?>">Logout </a></b>
						<?php } else { ?>
							     <b><a href="<?php echo home_url();?>/login-2/">Login</a></b>
						<?php } 
                            // login logout end here
						?>	
