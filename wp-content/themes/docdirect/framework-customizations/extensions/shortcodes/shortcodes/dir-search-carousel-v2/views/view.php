...
<div id="doc-homebannerslider" class="doc-homebannerslider doc-haslayout">
  <figure class="doc-bannerimg"> 
	...
	<?php }?>
    <figcaption class="doc-bannercontent">
      <div class="container">
        <div class="row">
          <div class="col-sm-offset-1 col-sm-10 col-xs-offset-0 col-xs-12">
            ...
            <div id="doc-homecatagoryslider-<?php echo esc_attr($flagslider);?>" class="doc-homecatagoryslider">
            <?php 
			$directories	   = array();
			$first_category	= '';
			$json			  = array();
				  ...
				  foreach ($cust_query as $key => $dir) {
                      ...
                      <div class="item" data-id="<?php echo intval( $dir->ID );?>" data-dir_name="<?php echo esc_attr( $title );?>"> 
                        <input name="directory_type" <?php echo esc_attr( $checked );?> id="input-<?php echo intval( $dir->ID );?>" data-dir_name="<?php echo esc_attr( $title );?>" type="radio" value="<?php echo esc_attr( $dir->post_name );?>">
                      	<span><?php esc_html_e( 'find a nearest','docdirect' );?>&nbsp;<?php echo get_the_title($dir->ID);?></span>
				...
				jQuery(document).ready(function(e) {
					...
					owl.owlCarousel({
						...
						afterMove: function (elem) {
						  ...
						  var id = elem.find(".owl-item").eq(current).find(".item").data('id');
						  var dir_name	= elem.find(".owl-item").eq(current).find(".item").data('dir_name');
                  ...
                  <div class="doc-fieldsetholder">
                    <?php if( isset( $dir_keywords ) && $dir_keywords === 'enable' ){?>
                        <div class="form-group">
                           <input type="text" name="by_name" placeholder="<?php esc_html_e('First name...','docdirect');?>" class="form-control">
                        </div>
                    <?php }?>
                    ...
                    <div class="row doc-rowmargin">
                      ...
                      <div class="col-sm-12 col-xs-12 doc-columnpadding">
                        <div class="doc-btnarea">
                          ...
                          <button class="doc-btn" type="reset"><?php esc_html_e('Reset Filter','docdirect');?></button>
                        </div>
                      </div>
                    </div>
                </fieldset>
