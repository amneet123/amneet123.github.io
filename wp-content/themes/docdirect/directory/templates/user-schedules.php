			...
			<div class="col-sm-offset-2 col-sm-10 col-xs-12">
				<div class="form-group">
					<select name="time_format" class="form-control">
						<option value="12hour" <?php echo isset( $db_time_format ) && $db_time_format === '12hour' ? 'selected' : '';?>><?php esc_html_e("Show Time in 12-hour clock",'docdirect');?></option>
						<option value="24hour" <?php echo isset( $db_time_format ) && $db_time_format === '24hour' ? 'selected' : '';?>><?php esc_html_e("Show Time in 24-hour clock",'docdirect');?></option>
					</select>
				</div>
