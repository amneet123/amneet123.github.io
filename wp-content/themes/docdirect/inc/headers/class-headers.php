    ...
    class docdirect_headers {
        ...
        public function docdirect_init_headers() {
			...
			if( isset( $header_type['gadget'] ) && $header_type['gadget'] === 'header_v2' ){
				...
				$header_classes	= 'tg-haslayout tg-inner-header';
			}
              ...
              <div class="container">
                <div class="row">
                  <div class="col-sm-12"> 
                    ...
                    <?php }?>
                    <?php if( !empty( $header_type['header_v2']['multilingual'] ) && $header_type['header_v2']['multilingual'] === 'enable' ){?>
        ...
        public function docdirect_prepare_registration_v2() {
			...
			if( $enable_login === 'enable' || $enable_resgistration === 'enable' ) {
                 ...
                 <?php } else {?>
                    	<a class="doc-btn" href="javascript:;" data-toggle="modal" data-target=".tg-user-modal"><?php esc_html_e('Become A Member','docdirect');?></a>
				<?php }?>
			<?php 
			}
			echo ob_get_clean();
